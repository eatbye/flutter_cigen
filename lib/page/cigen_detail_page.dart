...
class _CigenDetailPageState extends State<CigenDetailPage> {
  ...
  Widget detailWidget(){
    ...
    return ListView(
      ...
      children: <Widget>[
        Text(widget.word['word'], style: TextStyle(fontSize: 22.0),),
        SizedBox(height: 10,),
        Text('词根词缀', style: TextStyle(color: Colors.blue, fontSize: 16.0),),
        SizedBox(height: 10,),
        Padding(
        ...
        SizedBox(height: 10,),
        Text('词典释义', style: TextStyle(color: Colors.blue, fontSize: 16.0),),
        SizedBox(height: 10,),
        Padding(
          padding: const EdgeInsets.fromLTRB(8.0,0,8,0),
  ...
  Widget sentenceWidget(){
    ...
    if (sentence != ''){
      return Column(
        ...
        children: <Widget>[
          Text('单词例句', style: TextStyle(color: Colors.blue, fontSize: 16.0),),
          SizedBox(height: 10,),
          Padding(
            padding: const EdgeInsets.fromLTRB(8.0,0,8,0),
